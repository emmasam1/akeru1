...
function Ongoing() {
  ...
  return (
    <>
      ...
      <div>
        <h3 className="pro-h3-text">Ongoing trip</h3>
      </div>
      ...
      <table className="table table-borderless border-white table-responsive">
          ...
          {ongoing.map((e) => {
            return (
                <tr key={e.id}>
                  ...
                  <td><p className="complete rounded pon">{e.statuso}</p></td>
                  <td>
