  ...
  return (
    <>
      ...
      <div className="p-3 position-relative left-width-home left-width">
        ...
        <div className="card-body">
          ...
          <div className="col">
            <h3>{switchPageTitle(activeTabIndex)}</h3>
             ...
             <Link to="/admin-dashboard/new-request"><button className="btn btn-dark btn-sm mr-4">+ Add New request</button></Link> 
          </div>
          </div>
        ...
        {modal ? <Modal closeModal={closeModal} data={aRequest} /> : null}
      </div>
      </div>
      </div>
    </>
